                             ...
                             IMapper mapper) : IEmployeeService
{
    ...
    /// <param name="cancellationToken">Token to monitor for cancellation requests.</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the EmployeeDto if found; otherwise, null.
    /// </returns>
    ...
    /// The task result contains a collection of EmployeeDto objects associated with the specified department.
    /// </returns>
    ...
    /// <param name="cancellationToken">Token to monitor for cancellation requests.</param>
    /// <returns>
    /// A task that represents the asynchronous operation. The task result contains the created EmployeeDto object.
    /// </returns>
    /// <exception cref="ApplicationException">Thrown if the specified department does not exist or
    /// if the email is already associated with another employee.</exception>
