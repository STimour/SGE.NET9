...
public interface IAttendanceService
{
    ...
    /// The task result contains the attendance details after clock-in.
    /// </returns>
    ...
    /// The task result contains the attendance details after clock-out.
    /// </returns>
    ...
    Task<AttendanceDto> CreateAttendanceAsync(AttendanceCreateDto createAttendanceDto, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. 
    /// The task result contains the attendance details for the specified ID, or
    /// null if no record is found.</returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. 
    /// The task result contains an enumerable collection of attendance records matching the query parameters.</returns>
    Task<IEnumerable<AttendanceDto>> GetAttendancesByEmployeeAsync(int employeeId,
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. 
    /// The task result contains a collection of attendance details for the specified date.</returns>
    Task<IEnumerable<AttendanceDto>> GetAttendancesByDateAsync(DateTime date, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. 
    /// The task result contains the attendance details for the current day, or null if no attendance record exists.</returns>
    ...
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <returns>A task that represents the asynchronous operation. 
    /// The task result contains the total worked hours as a decimal value.</returns>
    Task<decimal> GetMonthlyWorkedHoursAsync(int employeeId, int year, int month, CancellationToken cancellationToken = default);
}