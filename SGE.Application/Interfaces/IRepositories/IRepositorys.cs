...
namespace SGE.Application.Interfaces.IRepositories;
    ...
    public interface IRepository<T> where T : class
    {
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>
        /// A task representing the asynchronous operation, with the result being all entities' enumerable of type <typeparamref name="T"/>.
        /// </returns>
        ...
        /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
        /// <returns>
        /// A task representing the asynchronous operation, with the result being an entities' enumerable of type <typeparamref name="T"/>
